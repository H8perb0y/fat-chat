...
.CSSTableGenerator tr:first-child td{
		background:-o-linear-gradient(bottom, #0083ff 5%, #0083ff 100%);	background:-webkit-gradient( linear, left top, left bottom, color-stop(0.05, #0083ff), color-stop(1, #0083ff) );
	background:-moz-linear-gradient( center top, #0083ff 5%, #0083ff 100% );
	filter:progid:DXImageTransform.Microsoft.gradient(startColorstr="#0083ff", endColorstr="#0083ff");	background: -o-linear-gradient(top,#0083ff,0083ff);
